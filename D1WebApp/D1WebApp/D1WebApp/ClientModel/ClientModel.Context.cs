...
namespace D1WebApp.ClientModel
{
    ...
    public partial class ClientEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetUserCartItemDetailReport_Result> GetUserCartItemDetailReport(string itemName, string userId, string customer, string fromDate, string toDate)
        {
            var itemNameParameter = itemName != null ?
                new ObjectParameter("ItemName", itemName) :
                new ObjectParameter("ItemName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetUserCartItemDetailReport_Result>("GetUserCartItemDetailReport", itemNameParameter, userIdParameter, customerParameter, fromDateParameter, toDateParameter);
        }
    
        public virtual int Update_it_tree_node_Data(string jsondata)
        {
            var jsondataParameter = jsondata != null ?
                new ObjectParameter("jsondata", jsondata) :
                new ObjectParameter("jsondata", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Update_it_tree_node_Data", jsondataParameter);
        }
    
        public virtual int Update_item_meta_Data(string jsondata)
        {
            var jsondataParameter = jsondata != null ?
                new ObjectParameter("jsondata", jsondata) :
                new ObjectParameter("jsondata", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Update_item_meta_Data", jsondataParameter);
        }
    
        public virtual int Update_majcls_meta_Data(string jsondata)
        {
            var jsondataParameter = jsondata != null ?
                new ObjectParameter("jsondata", jsondata) :
                new ObjectParameter("jsondata", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Update_majcls_meta_Data", jsondataParameter);
        }
    
        public virtual int Update_prodline_meta_Data(string jsondata)
        {
            var jsondataParameter = jsondata != null ?
                new ObjectParameter("jsondata", jsondata) :
                new ObjectParameter("jsondata", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Update_prodline_meta_Data", jsondataParameter);
        }
    
        public virtual ObjectResult<GetTreeNodeMetaList_Result> GetTreeNodeMetaList(string filterQuery, Nullable<int> pageno)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetTreeNodeMetaList_Result>("GetTreeNodeMetaList", filterQueryParameter, pagenoParameter);
        }
    
        public virtual ObjectResult<GetItemMetaList_Result> GetItemMetaList(string filterQuery, Nullable<int> pageno)
        {
            var filterQueryParameter = filterQuery != null ?
                new ObjectParameter("filterQuery", filterQuery) :
                new ObjectParameter("filterQuery", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetItemMetaList_Result>("GetItemMetaList", filterQueryParameter, pagenoParameter);
        }
    
        public virtual ObjectResult<GetMajClsMetaList_Result> GetMajClsMetaList(string filterQuery, Nullable<int> pageno)
        {
            var filterQueryParameter = filterQuery != null ?
                new ObjectParameter("filterQuery", filterQuery) :
                new ObjectParameter("filterQuery", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetMajClsMetaList_Result>("GetMajClsMetaList", filterQueryParameter, pagenoParameter);
        }
    
        public virtual ObjectResult<GetProdLineMetaList_Result> GetProdLineMetaList(string filterQuery, Nullable<int> pageno)
        {
            var filterQueryParameter = filterQuery != null ?
                new ObjectParameter("filterQuery", filterQuery) :
                new ObjectParameter("filterQuery", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetProdLineMetaList_Result>("GetProdLineMetaList", filterQueryParameter, pagenoParameter);
        }
    }
}
